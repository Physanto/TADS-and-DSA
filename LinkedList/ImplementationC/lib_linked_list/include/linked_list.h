...
/**
 * @brief crea un nuevo nodo al inicio de la lista enlazada
 *
 * Esta funcion crea un nodo con el elemento pasado por argumento al inicio
 * de la lista enlazada y apuntando a NULL
 *
 *
 *
 */
